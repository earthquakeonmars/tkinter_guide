...
# если первый элемент False, то изображение будет только на одном окне,
# а на всех других окнах будет стандартное изображение в виде перышка
...
root.attributes('-fullscreen', False) # если указать второй параметр True, то приложение будет запускаться во весь экран
